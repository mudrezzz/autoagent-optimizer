...
| V2.3.S4 | Candidate assembly + internal compile readiness | Done | `POST /api/arenas/{id}/candidates/assemble-compile` + per-candidate readiness (`draft/ready/failed`) + compile report in C2 accordion + FE/BE/QA |
