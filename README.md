...
- `Overall`: In Progress (V2.3.S1 + V2.3.S1a + V2.3.S2 + V2.3.S2b + V2.3.S2c + V2.3.S2d + V2.3.S3 + V2.3.S4 + V2.3.S4a + V2.3.S5 + V2.3.S5a + V2.3.S6 + V2.3.S6a + V2.3.S7 + V2.4.S1 + V2.4.S2 + V2.4.S3 + V2.4.S4 + V2.4.S5 + V2.4.S5a + V2.4.S5b + V2.4.S5c + V2.4.S6 + V2.4.S7 + I5.S2 + I5.S2b + I5.S3 + I5.S3a done)
...
5. `I5.S3a` adds Stage Mapping manual confirmation: ambiguous auto-map rows become `bound` after explicit human confirmation.
