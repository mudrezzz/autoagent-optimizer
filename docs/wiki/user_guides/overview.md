...
5. Подготовьте тестовые кейсы в C4 Dataset Studio и сохраните версию датасета.
6. Выберите кандидатов для тестов в C2 (чекбоксами).
7. Запустите тестовый этап и анализируйте результаты.
