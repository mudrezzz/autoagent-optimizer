...
_EVALUATOR_ADAPTER_CATALOG: dict[str, dict[str, Any]] = {
    "golden_oracle": {
        ...
        "supported_metric_refs": [
            ...
            "comparative:narrative_preservation",
            "comparative:length_discipline",
            "diagnostic:retrieval_coverage",
            "diagnostic:rerank_gain",
            "diagnostic:synthesis_drift",
            "diagnostic:proof_context_preservation",
        ],
    ...
    "llm_judge": {
        ...
        "supported_metric_refs": [
            "comparative:quality_f1",
            "comparative:human_likeness",
            "comparative:narrative_preservation",
            "comparative:ai_pattern_reduction",
            "comparative:length_discipline",
            "diagnostic:synthesis_drift",
            "diagnostic:pattern_cleanup_effectiveness",
            "diagnostic:proof_context_preservation",
            "diagnostic:over_sanitization_risk",
        ],
